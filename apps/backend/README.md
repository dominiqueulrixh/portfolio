...
## Beispiel-Inhalte
Die Vorlage soll neutral bleiben. Trage deine eigenen Texte, Medien und Sortierungen ein – die Felder sind oben beschrieben. Wenn du einen schnellen Start brauchst, lege dir interne Sample-Datensätze an, aber halte sie projektspezifisch, damit kein alter Kundenbezug in neuen Projekten landet.
